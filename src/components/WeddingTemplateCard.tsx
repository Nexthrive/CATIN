...
export default function WeddingTemplateCard({
  ...
  return (
    ...
    >
      ...
      >
        <Button
          className="rounded-full absolute py-3 px-6 -bottom-4 mx-auto bg-[#171717] text-white font-[family-name:var(--font-poppins)] text-xs font-medium md:py-4 md:px-8 md:text-sm lg:py-5 lg:px-10 lg:text-sm"
          asChild
        >
